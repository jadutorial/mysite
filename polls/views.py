...
##### render
# arguments: (request, template_name[, context][, context_instance]
#             [, content_type][, status][, current_app][, dirs][, using])
...
# view, passing the HttpRequest as the first argument to the view function.
